...
<head>
  ...
  <style>
    ...
    .card-title-link:hover h5 { text-decoration: underline; }
    .logo { border-radius: 100%; width: 35px; height: 35px; margin-left: 20px; }
    .description { background-color: rgb(125, 159, 159); color: white; font-weight: 400; border-radius: 10px; }
    a { margin-left: 15px; color: aliceblue; }
  </style>
</head>
<body>
...
<nav class="navbar">
  <div class="aa">
    ...
    <div class="navbar-icons">
      <a href="<%= ("admin".equals(session.getAttribute("role"))) ? "login1.jsp" : "login.jsp" %>">
        <img src="../image/member.png" alt="member" class="icons mx-2">
      </a>
  ...
  <section class="product">
    ...
    <div class="product-details">
      ...
      <div class="d-flex align-items-center">
        ...
        <button class="btn btn-outline-secondary" id="decrease-btn" style="background-color: grey;border-radius: 10px;">-</button>
        <input type="number" id="quantity-input" class="mx-2" value="1" min="1" style="width: 80px; text-align: center;">
        <button class="btn btn-outline-secondary" id="increase-btn" style="background-color: grey;border-radius: 10px;">+</button>
      </div>
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll("button[data-group='sweetness'], button[data-group='ice']").forEach(btn => {
      btn.addEventListener("click", function () {
        const group = this.getAttribute("data-group");
        document.querySelectorAll(`button[data-group='${group}']`).forEach(b => b.classList.remove("selected"));
